...
More examples, including some with in-depth explanations and interactive visualizations, can be seen `on nbviewer <http://nbviewer.ipython.org/github/hoburg/gpkit/tree/master/docs/source/ipynb/>`_.

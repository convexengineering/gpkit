...
are all posynomials.  Alternatively, monomials can be defined as the subset of posynomials with only one term.  Using these definitions, a GP in Standard Form is written as:

...
python $PYLINT --rcfile=$WORKSPACE/.pylintrc --disable=no-member,attribute-defined-outside-init,invalid-name,too-many-locals,redefined-outer-name,wrong-import-position $@ $WORKSPACE/docs/source/examples/*.py

...
python $PYLINT --rcfile=$WORKSPACE/.pylintrc --disable=attribute-defined-outside-init,missing-docstring,invalid-name,too-many-locals,redefined-outer-name,wrong-import-position $@ $WORKSPACE/docs/source/examples/*.py
